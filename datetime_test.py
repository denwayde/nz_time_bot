...
print(dt(dt.now().year, dt.now().month, dt.now().day+1).date())#так можно манипулировать датами(так мы прибавили один день к текушей дате)
...
#ТЕПЕРЬ НУЖНО ПРИДУМАТЬ КАК МОЖНО ВЫЧИТАТЬ ВРЕМЕНА 
